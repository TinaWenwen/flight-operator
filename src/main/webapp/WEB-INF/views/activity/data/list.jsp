...
<div class="admin-content">
    <div class="admin-content-body">
        ...
        <hr class="am-hr">
        <form class="am-form am-form-inline searchForm" role="form" id="form1" action="activity/data/list" method="get">
            <div class="am-g">
...
<script>
    function toUpdate(id) {
        window.location.href = "activity/data/update/" + id;
    ...
    function updateStatus(id, status) {
        ...
        layer.confirm('确定' + action + '?', {icon: 3, title: '提示'}, function (index) {
            ...
            $.post("activity/data/status/update/" + id, {}, function (data) {
                if (data.code == 1) {
                    notify.success('操作成功!');
                    setTimeout(function () {
    ...
    $(document).ready(function () {
        ...
        $('#insertBtn').click(function () {
            window.location.href = 'activity/data/insert';
        });
    });
</script>
</html>
